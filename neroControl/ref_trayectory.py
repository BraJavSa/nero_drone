#!/usr/bin/env python3
# ROS2 node for publishing a lemniscate trajectory reference for the Bebop drone
import rclpy
...
class TrajectoryPublisher(Node):
    def __init__(self):
        ...
        self.get_logger().info(f"Trajectory publisher started: Amplitude={self.amplitude_x}, w={self.w}")
    ...
    def timer_cb(self):
        ...
        msg.data = [float(pos_o[0]), float(pos_o[1]), float(pos_o[2]), float(yaw_o),
