...
BOUNDS = [
    (0.1,  5.0), (0.1,  5.0), (1.0,  8.0), (0.1, 10.0),  # KP: x, y, z, yaw
    (0.2,  0.9), (0.2,  0.9), (0.1,  0.8), (0.1, 10.0),  # KSP: x, y, z, yaw
    (1.0, 10.0), (1.0, 10.0), (0.5,  5.0), (0.0,  5.0),  # KD: x, y, z, yaw
    (0.0,  2.0), (0.0,  2.0), (0.0,  2.0), (0.0,  5.0),  # KSD: x, y, z, yaw
]
