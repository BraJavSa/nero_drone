...
# Verificar dimensión del vector de entrada
# Nuevo formato: v_now(4) + u_hist(W×4) + u_now(4) = 4*(W+2)
...
# 5. CARGAR Y PRUEBA DE VELOCIDAD
f_compiled = ca.external('f_mlp', so_file)

# Input de prueba con el nuevo formato
# [ v_now(4) | u_hist(W*4) | u_now(4) ]
